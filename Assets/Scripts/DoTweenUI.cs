...
public class DoTweenUI : MonoBehaviour
{
    ...
    public void lvlCompletePanel()
    {
        ...
        scoreText.text = "";
        //scoreText.DOText("99999", revealDuration/2f) added animation to score text and revealDuration part when it's ready.
        //.SetDelay(revealDuration); when animation will be active(i guess xd)

        scoreText.DOText("99999", revealDuration/2f).SetDelay(revealDuration);
